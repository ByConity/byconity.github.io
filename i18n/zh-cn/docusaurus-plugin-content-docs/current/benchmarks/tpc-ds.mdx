...
|-------------|--------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|------------------------------------|
| 环境配置      | Memory: 256GB<br>Disk: ATA, 7200rpm, partitioned:gpt<br>System: Linux 4.14.81.bm.30-amd64 x86_64, Debian GNU/Linux 9 |                                                                |                                    |
...
| 其他配置      | distributed_product_mode = 'global',<br>partial_merge_join_optimizations = 1                           | bucket配置:维表1，returns表10-20，sales表100-200                 | Hive Catalog，ORC format, Xmx200GB |
