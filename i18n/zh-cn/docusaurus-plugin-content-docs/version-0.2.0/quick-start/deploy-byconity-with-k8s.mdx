...
运行`CREATE WAREHOUSE` 数据定义语言 在 Byconity 创建逻辑虚拟仓库
...
高可用的 ByConity 集群功能开启需要打开所有组件的 zookeeper 配置，参考[server.yaml](https://github.com/ByConity/byconity-deploy/blob/master/chart/byconity/files/server.yaml#L96)
