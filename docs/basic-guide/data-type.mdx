...
Range of values: [1900-01-01 00:00:00, 2299-12-31 23:59:59.99999999] (Note: the precision of the maximum value is 8).
...
You can use [date](https://clickhouse.com/docs/en/sql-reference/data-types/date) and [datetime](https://clickhouse.com/docs/en/sqlreference/data-types/datetime) values of type **Interval** are used in arithmetic operations on values of type **Interval**. For example, you can add 4 days to the current time:
