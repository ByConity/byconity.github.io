...
_Note: When you install the package again (such as during an upgrade), you do not need to execute the `start` command._
...
6. Check the status of the computation group
