...
As mentioned in the FoundationDB cluster deployment, after configuring the FoundationDB servers, a `fdb.cluster` file will be generated. This file is used by FoundationDB clients to connect to the FoundationDB servers. Detailed instructions can be found in the [official documentation](./foundationdb-installation).
