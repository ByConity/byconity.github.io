...
Our core developers develop ByConity using a plugin called Dev Containers in VS Code.This plugin allows us to connect to a Docker container environment running on a Debian 11 virtual machine.So we recommend you to do the same in case of compatibility issues.
