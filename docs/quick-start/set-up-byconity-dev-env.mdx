...
The easiest way to build a development environment is to develop in a Docker container in vscode using the Dev Containers plugin. 
This way, you don't have to spend a lot of time configuring your environment and it works fine in Windows, Mac(M CPU) and Mac(Intel CPU) simultaneously.
