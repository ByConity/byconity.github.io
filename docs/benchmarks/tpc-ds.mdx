...
![Figure 1: TPC-DS 99 query total time](./assets/tpc-ds-query-total-time.jpeg)
...
![Figure 2: Performance comparison of TPC-DS basic query](./assets/perf-comparison-TPC-DS-basic-query.png)
...
![Figure 3: Performance comparison of TPC-DS Join Query](./assets/perf-comparison-TPC-DS-join-query.png)
...
![Figure 4: Performance comparison of TPC-DS Aggregation Query](./assets/perf-comparison-TPC-DS-agg-query.png)
...
![Figure 5. Performance comparison of TPC-DS subquery](./assets/perf-comparison-TPC-DS-sub-query.png)
...
![Figure 6. Performance comparison of TPC-DS window function query](./assets/perf-comparison-TPC-DS-window-query.png) !(./f1)
