---
title: Configure Background Tasks
tags:
  - Docs
---
...
| cnch_merge_pick_worker_algo | 'RM', the algorithm when selecting workers, pick from RM by default. | When the concurrency is large, it needs to be set to '**RoundRobin**' |
...
- About cnch_merge_only_realtime_partition and max